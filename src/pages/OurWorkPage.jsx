...
const OurWorkPage = ({ navigate, openGetInvolved }) => (
    <div className="pb-20">
            ...
            <FadeInSection>
                <div className="text-center max-w-3xl mx-auto">
                    ...
                    >
                        ...
                        <span className="text-sm text-brand font-medium">Our Work</span>
                    </motion.div>
        ...
        <section className="px-6 bg-gradient-to-b from-background via-muted to-card py-20 relative overflow-hidden">
                        ...
                        >
                            <div className="aspect-[4/5] relative overflow-hidden rounded-3xl shadow-2xl">
                                ...
                                <div className="absolute bottom-0 left-0 p-6 md:p-8 text-white">
                                    <div className="w-12 h-12 md:w-14 md:h-14 rounded-2xl bg-primary/20 backdrop-blur-sm flex items-center justify-center mb-4 border border-primary/30">
                    ...
                    <div className="relative rounded-[2rem] overflow-hidden shadow-2xl bg-slate-950 isolate">
                        ...
                        <div className="relative z-10 grid md:grid-cols-2 lg:grid-cols-5 gap-8 md:gap-12 p-6 md:p-12 lg:p-16 items-center">
                            ...
                            <div className="lg:col-span-2 space-y-6">
                                ...
                                <p className="text-base md:text-lg text-brand-foreground/80 leading-relaxed">
                                ...
                                {[
                                    ...
                                    >
                                        <div className="flex items-start justify-between mb-2 md:mb-3">
                                            ...
                                            <ArrowRight className="text-white/30 group-hover:text-primary group-hover:translate-x-1 transition-all" size={16} />
                                        </div>
                                        <h4 className="font-bold text-white text-base md:text-lg mb-1">{action.label}</h4>
                                        <p className="text-xs md:text-sm text-brand-foreground/60 font-medium">{action.desc}</p>
                                    </motion.button>
                                ))}
                            </div>
                        </div>
