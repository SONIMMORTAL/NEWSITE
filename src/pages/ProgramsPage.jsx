        ...
        <FadeInSection>
            <div className="text-center max-w-3xl mx-auto mb-16">
                ...
                >
                    ...
                    <span className="text-sm text-brand font-medium">Core Departments</span>
                </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="relative rounded-3xl overflow-hidden bg-brand">
                        ...
                        <div className="relative z-10 p-8 md:p-12 flex flex-col md:flex-row gap-10 items-start md:items-center">
                            <div className="flex-1 space-y-6">
                                ...
                                <p className="text-brand-foreground/90 text-lg leading-relaxed max-w-xl">
                            ...
                            <div className="w-full md:w-auto flex flex-col gap-4 min-w-[220px]">
                                ...
                                <div className="flex items-center justify-center gap-2 text-brand-foreground/60 text-xs font-medium">
                                    <Users size={14} />
                                    Bi-Weekly Sessions
                                </div>
                            </div>
                        ...
                        <div className="relative z-10 h-full flex flex-col justify-between p-8">
                            <div className="flex justify-between items-start">
                                <div className="h-16 w-16 rounded-2xl overflow-hidden shadow-lg border border-white/20 group-hover:scale-110 transition-transform">
                                    <img loading="lazy" decoding="async" src={ASSETS.youthIcon} className="w-full h-full object-cover" alt="Youth Icon" />
                                </div>
                            ...
                            <div>
                                ...
                                <div onClick={(e) => e.stopPropagation()} className="relative z-20 mb-4">
                                    <a
                                        ...
                                        className="inline-block px-5 py-2.5 bg-primary text-blue-900 rounded-xl font-bold hover:bg-primary transition-colors shadow-lg text-sm"
                                    >
            ...
            <FadeInSection delay={0.2}>
                <GlowingCard glowColor="green" onClick={() => openContact('Social Services')} className="h-full group cursor-pointer">
                    <div className="relative h-full min-h-[320px] rounded-3xl overflow-hidden bg-brand">
                        <div className="absolute inset-0">
                            <img loading="lazy" decoding="async"
                                ...
                                alt="Social Services"
                            />
                            <div className="absolute inset-0 bg-gradient-to-br from-brand/90 to-brand/60" />
                        </div>

                        <div className="relative z-10 h-full flex flex-col justify-between p-6">
                            <div className="h-14 w-14 rounded-2xl overflow-hidden bg-white/10 border border-white/20 shadow-lg">
                                <img loading="lazy" decoding="async" src={ASSETS.socialIcon} className="w-full h-full object-cover" alt="Social Icon" />
                            </div>

                            <div>
                                <h3 className="text-xl font-bold text-white mb-2 font-display">Social Services</h3>
                                <p className="text-brand-foreground/80 text-sm leading-relaxed mb-4">
                                    High-Impact Volunteerism. Neighbor to Neighbor counseling and health awareness fairs.
                                </p>
                                <motion.div
                                    className="w-10 h-10 rounded-full bg-primary text-brand flex items-center justify-center"
            ...
            <FadeInSection delay={0.3}>
                <GlowingCard glowColor="yellow" onClick={() => openContact('Sports & Rec')} className="h-full group cursor-pointer">
                    <div className="relative h-full min-h-[280px] rounded-3xl overflow-hidden bg-gradient-to-br from-yellow-900 to-brand">
                        <div className="absolute inset-0">
                            <img loading="lazy" decoding="async"
                                src={ASSETS.heroBg}
                                ...
                                alt="Sports"
                            />
                            <div className="absolute inset-0 bg-gradient-to-br from-yellow-950/80 to-brand/60 mix-blend-multiply" />
                        </div>
                        ...
                        <div className="relative z-10 h-full flex flex-col justify-between p-6">
                            ...
                            <div>
                                ...
                                <motion.div
                                    className="w-10 h-10 rounded-full bg-white/20 text-white flex items-center justify-center group-hover:bg-primary group-hover:text-brand transition-all"
                                    whileHover={{ scale: 1.1 }}
                                >
                                    <ArrowRight size={16} />
                                </motion.div>
            ...
            <FadeInSection delay={0.4} className="md:col-span-2">
                <motion.div
                    ...
                    className="h-full min-h-[200px] border-2 border-dashed border-border hover:border-primary rounded-3xl flex flex-col items-center justify-center text-center p-8 cursor-pointer bg-card hover:bg-secondary/50 transition-all"
                ...
                >
                    ...
                    <p className="text-muted-foreground text-sm">Contact us directly to get involved.</p>
                </motion.div>
            </FadeInSection>
        </div>
    </div>
