...
export const SOCIAL_SERVICES = {
    business: {
        ...
        description: "Empowering local entrepreneurs through bi-weekly strategy groups. Gain accountability, financial literacy, and marketing tools to scale your business.",
        tags: ["Peer-to-Peer Accountability", "Sales Funnels", "Financial Planning"]
    },
    youth: {
        title: "Kids Depo Services",
        description: "Home of DreamKids & BossyBabies. Creating rites of passage curriculums for troubled and at-risk youth. Ages 5-18."
    },
    social: {
        title: "Social Services",
        description: "High-Impact Volunteerism. Neighbor to Neighbor counseling and health awareness fairs."
    },
    sports: {
        title: "Sports & Rec",
